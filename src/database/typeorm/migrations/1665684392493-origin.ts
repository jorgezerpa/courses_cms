...
export class origin1665684392493 implements MigrationInterface {
    name = 'origin1665684392493'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`cart\` (\`id\` int NOT NULL AUTO_INCREMENT, \`totalAmount\` int NOT NULL, \`clientId\` int NULL, \`merchantIdId\` int NULL, UNIQUE INDEX \`REL_4355dbbef8931576d9e362d4ae\` (\`clientId\`), UNIQUE INDEX \`REL_8ef45624bce016fb1aa211c8e4\` (\`merchantIdId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
