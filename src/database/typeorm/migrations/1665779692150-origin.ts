...
export class origin1665779692150 implements MigrationInterface {
    name = 'origin1665779692150'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`paymentMethodId\` varchar(255) NOT NULL, \`totalAmount\` int NOT NULL, \`shippingId\` int NULL, \`clientId\` int NULL, \`merchantId\` int NULL, UNIQUE INDEX \`REL_8bf3257f3efd245c9f292c169c\` (\`shippingId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order\` DROP FOREIGN KEY \`FK_8bf3257f3efd245c9f292c169c5\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_8bf3257f3efd245c9f292c169c\` ON \`order\``);
