...
export class origin1665684150899 implements MigrationInterface {
    name = 'origin1665684150899'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`cart\` CHANGE \`merchantId\` \`merchantIdId\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`cart\` ADD UNIQUE INDEX \`IDX_8ef45624bce016fb1aa211c8e4\` (\`merchantIdId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`auth\` ADD CONSTRAINT \`FK_2c3f7a74773a0258b9bb0e91a5a\` FOREIGN KEY (\`clientId\`) REFERENCES \`client\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cart\` DROP INDEX \`IDX_8ef45624bce016fb1aa211c8e4\``);
        await queryRunner.query(`ALTER TABLE \`cart\` CHANGE \`merchantIdId\` \`merchantIdId\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`auth_merchant\` ADD CONSTRAINT \`FK_835fe9179e2572bbd1856eb9d64\` FOREIGN KEY (\`merchantId\`) REFERENCES \`merchant\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cart\` CHANGE \`merchantIdId\` \`merchantId\` int NOT NULL`);
    }
