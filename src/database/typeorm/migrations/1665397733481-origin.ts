...
export class origin1665397733481 implements MigrationInterface {
    name = 'origin1665397733481'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`merchant\` DROP COLUMN \`phone\``);
        await queryRunner.query(`ALTER TABLE \`merchant\` ADD \`phone\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order\` ADD CONSTRAINT \`FK_9b27855a9c2ade186e5c55d1ec3\` FOREIGN KEY (\`clientId\`) REFERENCES \`client\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`merchant\` DROP COLUMN \`phone\``);
        await queryRunner.query(`ALTER TABLE \`merchant\` ADD \`phone\` int NOT NULL`);
