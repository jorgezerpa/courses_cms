...
export class origin1666266601565 implements MigrationInterface {
    name = 'origin1666266601565'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`auth_merchant\` (\`id\` int NOT NULL, \`email\` varchar(255) NOT NULL, \`recoveryToken\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`merchantId\` int NULL, UNIQUE INDEX \`REL_835fe9179e2572bbd1856eb9d6\` (\`merchantId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`price\` int NOT NULL, \`quantity\` varchar(255) NOT NULL, \`image\` varchar(255) NOT NULL, \`merchantId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
